...
function addMarker(position, idx, place) {
    ...
    kakao.maps.event.addListener(marker, 'click', function() {
        // 클릭한 마커의 위치로 카카오 지도를 연다
        var link = `https://map.kakao.com/link/map/${place.place_name},${position.getLat()},${position.getLng()}`;
        window.open(link);
    });
